...
import { init as initCAM } from '../../mode/cam/app/init-ui.js';
import { init as initDRAG } from '../../mode/drag/init-ui.js';
import { init as initFDM } from '../../mode/fdm/app/init-ui.js';
import { init as initLaser } from '../../mode/laser/init-ui.js';
import { init as initSLA } from '../../mode/sla/app/init-ui.js';
...
import { menu as menuFDM } from '../../mode/fdm/app/init-menu.js';
import { menu as menuLaser } from '../../mode/laser/init-menu.js';
import { menu as menuSLA } from '../../mode/sla/app/init-menu.js';
...
function checkSeed(then) {
    ...
    if (!sdb[SEED]) {
        ...
        if (!SETUP.s && api.feature.seed) {
            ...
            platform.load_stl("/school-slicer/obj/cube.stl", function(vert) {
...
export function init_input() {
    ...
    Object.assign(ui, {
        ...
        fwRetract:        newBoolean(LANG.dv_retr_s, onBooleanClick, {title:LANG.dv_retr_l, modes:FDM, trigger}),
        ...
        exportPreview:    newBoolean(LANG.op_excp_s, preferences.booleanSave, {title:LANG.op_excp_l}),
        exportOcto:       newBoolean(LANG.op_exop_s, preferences.booleanSave, {title:LANG.op_exop_l}),
        exportThumb:      newBoolean(LANG.op_exth_s, preferences.booleanSave, {title:LANG.op_exth_l, modes:FDM}),
